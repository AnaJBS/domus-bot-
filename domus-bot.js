  ...
  switch (estado) {
    ...
    case 'aluguel_filhos': {
      ...
      if (txt.startsWith('s')) {
        ...
        console.log('Domus Bot: Ok, e você possui pet? (Responda Sim ou Não)');
        estado = 'aluguel_pet';
      } else {
        console.log('Domus Bot: Me responda apenas Sim ou Não.');
      }
      break;
    }
    ...
    case 'aluguel_idade_filhos':
      ...
      console.log('Domus Bot: Obrigado! Você possui pet? ( Responda Sim ou Não)');
      estado = 'aluguel_pet';
      break;
...
function mostrarMenuGarantia() {
  console.log(
    ...
    '  1️- Um fiador com dois bens imóveis;\n' +
    '  2- Dois fiadores com um bem imóvel cada um;\n' +
    '  3️- CredPago (empresa que atua como sua fiadora).\n'
  );
